			 ...
			 /*   $( ".business-start-date" ).datepicker({
			  ...
			  /*$("#application-form").submit(function(e) {
                ...
                function promoCodeUpdate(res){
                    $(".application-note").html("<strong>($0 application processing fee)</strong>");
                }
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><?php echo $form->labelEx($app_form,'state'); ?>&nbsp;&nbsp;/&nbsp;&nbsp;<?php echo $form->labelEx($app_form,'city'); ?></label>
						<div class="col-sm-4">
						<?php echo $form->dropDownList($app_form,'state', CHtml::listData($state,'abbrev','name'), array(
                                'prompt'=>'State',
								'ajax' => array(
									'type'=>'POST',
									'url'=>CController::createUrl('applicationForm/dynamicCity'),
									'update'=>'#'.CHtml::activeId($app_form,'city')
                                 ))); 
							$cityValues = array();
							if ( $app_form->state )
							{
						...
						<div class="col-sm-4">
						<?php echo $form->dropDownList($app_form,'city',$cityValues, array('prompt'=>'City')); ?>
						</div>
						

						<br />
						<br />
							<?php echo $form->labelEx($app_form,'zip', array('class' => 'col-sm-4 control-label')); ?>
						<div class="col-sm-4 ">
		...
		<div class="col-md-6">
			<div class="form-group" style="padding-top:2px;">
				...
				<div class="col-sm-8">
					...
					<?php echo CHtml::textField('other',$other_line,array('class' => 'form-control other-line-credit other_line_of_credit'));?>
				</div>
			</div>
		</div>
	</div>
