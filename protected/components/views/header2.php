		...
		<div class="row">
			...
			<div class="col-sm-6 login">
				...
				<div class="row">
						...
						<a class="btn btn-primary btn-lg orange-btn hidden-xs col-md-10 col-sm-10" style="margin-top:8px; margin-bottom:8px;" role="button" href="<?php echo $baseUrl; ?>/applicationForm/creditApplication">Apply Now</a>
