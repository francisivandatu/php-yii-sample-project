		...
		<div class="col-sm-6 payment-method-wrapper">
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					<?php echo CHtml::submitButton('Process Payment Now', array('class' => 'btn btn-primary submit-btn btn-lg',)); ?>
				</div>
			</div>
			<div class="row text-center" style="margin-top: 13px;margin-bottom: 13px;">OR</div>
			<div class="row">
				<div class="col-sm-12 text-center">
					<a href="<?php echo $paypalApiApprovalLink; ?>" class="pay-with-paypal" ><img style="height: 42px;" src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/paynow.png"/></a>
				</div>
			</div>
		</div>
